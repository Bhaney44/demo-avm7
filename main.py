...
def call_vrf(app_client: client.ApplicationClient):
    ...
    msg: bytes = bytes.fromhex("528b9e23d93d0e020a119d7ba213f6beb1c1f3495a217166ecd20f5a70e7c2d7")
    proof: bytes = bytes.fromhex("372a3afb42f55449c94aaa5f274f26543e77e8d8af4babee1a6fbc1c0391aa9e6e0b8d8d7f4ed045d5b517fea8ad3566025ae90d2f29f632e38384b4c4f5b9eb741c6e446b0f540c1b3761d814438b04")
    pub_key: bytes = bytes.fromhex("3a2740da7a0788ebb12a52154acbcca1813c128ca0b249e93f8eb6563fee418d")
    address = encode_address(pub_key)

    atc = AtomicTransactionComposer()
    app_client.add_method_call(atc, DemoAVM7.vrf_verify, msg=msg, proof=proof, pub_key=address)
    for x in range(8):
